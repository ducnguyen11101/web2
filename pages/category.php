  ...
  <div class="container">
    <div class="p-5">
      ...
      if ($isCreate) {
        ...
        <a href="../category_control/addcategory.php" class="btn btn-success mt-5 mb-1">Thêm mới danh mục</a>
        <a href="../category_control/addsubcategory.php" class="btn btn-success mt-5 mb-1 ms-5">Thêm mới thể loại</a>
      </div>';
      }
      ?>
      <div class="d-flex">
